...
```
Task(
  prompt="Read /Users/ju571nk3n/Documents/Dev-Factory/Chartter/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ju571nk3n/Documents/Dev-Factory/Chartter/.claude/get-shit-done/templates/SECURITY.md`
