...
```bash
INIT=$(node "/Users/ju571nk3n/Documents/Dev-Factory/Chartter/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/ju571nk3n/Documents/Dev-Factory/Chartter/.claude/get-shit-done/templates/spec.md.
