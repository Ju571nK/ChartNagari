...
- **Global scope**: `/Users/ju571nk3n/Documents/Dev-Factory/Chartter/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ju571nk3n/Documents/Dev-Factory/Chartter/.claude/notes/`)
...
2. Glob `/Users/ju571nk3n/Documents/Dev-Factory/Chartter/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ju571nk3n/Documents/Dev-Factory/Chartter/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ju571nk3n/Documents/Dev-Factory/Chartter/.claude/notes/` — works in any directory
